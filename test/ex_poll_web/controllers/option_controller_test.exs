defmodule ExPollWeb.OptionControllerTest do
  ...
  describe "create option" do
    test "renders option when data is valid", %{conn: conn} do
      ...
      conn = post(conn, Routes.poll_option_path(conn, :create, poll.id), option: @create_option_attrs)
    ...
    test "renders errors when data is invalid", %{conn: conn} do
      ...
      conn = post(conn, Routes.poll_option_path(conn, :create, poll.id), option: @invalid_option_attrs)
